    ...
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '20px' }}>
      ...
      {activeTab === 'products' && (
        <div>
          ...
          {/* Add Product Form */}
          <form onSubmit={handleAddProduct} style={{ background: '#f9f9f9', padding: '15px', borderRadius: '8px', marginBottom: '25px', border: '1px solid #ddd', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            <h4 style={{ gridColumn: 'span 2', margin: '0 0 10px 0' }}>Add New Product</h4>
            ...
            <button type="submit" className="btn-primary" style={{ gridColumn: 'span 2', padding: '10px', cursor: 'pointer' }}>Add Product to DB</button>
          </form>
